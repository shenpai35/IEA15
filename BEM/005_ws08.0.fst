...
---------------------- INPUT FILES ---------------------------------------------
"IEA-15-240-RWT-Monopile_ElastoDyn_005_ws08.0.dat" EDFile        - Name of file containing ElastoDyn input parameters (quoted string)
...
"IEA-15-240-RWT_InflowFile_005_ws08.0.dat" InflowFile    - Name of file containing inflow wind input parameters (quoted string)
"IEA-15-240-RWT-Monopile_AeroDyn15.dat" AeroFile      - Name of file containing aerodynamic input parameters (quoted string)
"IEA-15-240-RWT-Monopile_ServoDyn_005_ws08.0.dat" ServoFile     - Name of file containing control and electrical-drive input parameters (quoted string)
